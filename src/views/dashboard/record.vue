            ...
            <v-dialog v-model="addNewDuty" width="600px">
              <v-card>
                ...
                <v-card-actions style="margin-left: 10px; margin-top: -30px; margin-bottom: 20px;">
                  <v-btn color="green darken-1" text @click="add">Add Record</v-btn>
...
export default {
  ...
  methods: {
    ...
    getRecord() {
      ...
      axios.get('http://admin-database.herokuapp.com/visitor-record/getAll')
      .then(Response => {
    ...
    add() {
      ...
      axios.post('http://admin-database.herokuapp.com/visitor-record/addNewVisitorRecord', data, config)
